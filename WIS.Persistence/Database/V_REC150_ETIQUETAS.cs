namespace WIS.Persistence.Database
{
    ...
    [Table("V_REC150_ETIQUETAS")]
    public partial class V_REC150_ETIQUETAS
    {
        [Key]
        [Column(Order = 0)]
        ...
        [StringLength(40)]
        public string CD_ENDERECO_UT { get; set; }

        [StringLength(40)]
        public string CD_ENDERECO_SUGERIDO_UT { get; set; }

        [StringLength(50)]
        public string CD_GRUPO_UT { get; set; }

        public short? CD_SITUACAO_UT { get; set; }

        [StringLength(10)]
        public string CD_UNIDAD_BULTO_UT { get; set; }

        public DateTime? DT_ADDROW_UT { get; set; }

        public DateTime? DT_UPDROW_UT { get; set; }

        [StringLength(40)]
        public string NU_EXTERNO_UNIDAD_UT { get; set; }

        public int? NU_UNIDAD_TRANSPORTE_UT { get; set; }

        public decimal? PS_REAL_UT { get; set; }

        [StringLength(10)]
        public string QT_BULTO_UT { get; set; }

        public decimal? QT_CONTENEDOR_UT { get; set; }

        [StringLength(3)]
        public string TP_UNIDAD_TRANSPORTE_UT { get; set; }

        public decimal? VL_ALTURA_UT { get; set; }

        public decimal? VL_LARGURA_UT { get; set; }

        public decimal? VL_PROFUNDIDADE_UT { get; set; }
