namespace WIS.Persistence.Database
{
    ...
    [Table("V_PLANIFICACION_LIB_WPRE670")]
    public partial class V_PLANIFICACION_LIB_WPRE670
    {
        [Key]
        [Column(Order = 0)]
        [StringLength(40)]
        ...
        public DateTime? DT_GENERICO_1_DET { get; set; }

        public decimal? NU_GENERICO_1_DET { get; set; }

        [StringLength(400)]
        [Column]
        public string VL_GENERICO_1_DET { get; set; }
