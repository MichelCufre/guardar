...
export default function DOC021(props) {
    ...
    return (
        ...
        <Page
            icon="fas fa-file"
            title={t("DOC021_Sec0_pageTitle_Titulo")}
            {...props}
        >
                <Form
                    id="DOC020_form_1"
                    ...
                    <fieldset className="row" style={fieldSetStyle}>
                        <legend>{t("DOC021_frm1_lbl_Totales")}</legend>
                            <div className="row col-12">
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_DISPONIBLE">{t("DOC021_frm1_lbl_QT_DISPONIBLE")}</label>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_RESERVADA">{t("DOC021_frm1_lbl_QT_RESERVADA")}</label>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_MERCADERIA">{t("DOC021_frm1_lbl_QT_MERCADERIA")}</label>
                            ...
                            <div className="row col-12">
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_INGRESADA">{t("DOC021_frm1_lbl_QT_INGRESADA")}</label>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_DESAFECTADA">{t("DOC021_frm1_lbl_QT_DESAFECTADA")}</label>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="QT_EXISTENCIA">{t("DOC021_frm1_lbl_QT_EXISTENCIA")}</label>
