...
export function DOC100Create(props) {
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                id="DOC100_form_Create"
                application="DOC100Create"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("DOC100_Sec0_modalTitle_Create")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col>
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreate" variant="primary" label="General_Sec0_btn_Confirmar" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
