...
export function EXP040CreateEgresoModal(props) {
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                id="EXP040_form_CreateEgreso"
                application="EXP040CreateEgreso"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("EXP040_Sec0_modalTitle_Titulo")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col md={6}>
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            ...
                            <div className="form-group">
                                ...
                                {/*<FormWarningMessage message={t("WEXP040_Sec0_Error_Er009_RutaYaAsociada")} show={warnRutaAsociada} />*/}
                            </div>
                        </Col>
                    </Row>
                    <hr />
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreateEgreso" variant="primary" label="EXP040_frm1_btn_crear" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
