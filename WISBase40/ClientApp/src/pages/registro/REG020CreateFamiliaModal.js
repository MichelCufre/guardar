...
function InternalREG020CreateFamiliaModal(props) {
        ...
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreateFamilia" variant="primary" label="REG020_frm1_btn_CREAR" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
...
export const REG020CreateFamiliaModal = withPageContext(InternalREG020CreateFamiliaModal);