...
export function REG310ReglasUpdateModal(props) {
    ...
    const handleCloseModal = (valorParametro, nexus) => {
        if (nexus && valorParametro != null) {
            var grid = nexus.getGrid("REG310ReglasUpdate_grid_1");
    ...
    const handleGridBeforeValidate = (context, data, nexus) => {
        const rowsEntrada = nexus.getGrid("REG310ReglasUpdate_grid_1").getModifiedRows();
    ...
    const onBeforeInitialize = (context, form, query, nexus) => {
        query.parameters = [
            { id: "nuRegla", value: props.nuRegla },
        ];
    }
    ...
    const onBeforeSubmit = (context, form, query, nexus) => {
        ...
        if (nexus.getGrid("REG310ReglasUpdate_grid_1").hasError()) {
    ...
    return (
        ...
        <Form
            application="REG310ReglasUpdate"
            id="REG310ReglasUpdate_form_1"
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title>{t("REG300_Sec0_Title_EditarRegla")}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Container fluid>
                    <Row>
