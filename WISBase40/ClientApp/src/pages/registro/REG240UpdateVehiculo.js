...
export function REG240UpdateVehiculoModal(props) {
    ...
    const handleFormBeforeInitialize = (context, form, query, nexus) => {
        query.parameters = [{ id: "vehiculo", value: props.vehiculo }];
    }
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                application="REG240UpdateVehiculo"
                id="REG240_form_UpdateVehiculo"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("REG240_Sec0_modalTitle_TituloModificar")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col>
                            <div className="form-group">
                                <label htmlFor="estado">{t("REG240_frm_lbl_Estado")}</label>
                                <FieldSelect name="estado" />
                            ...
                            <div className="form-group">
                                ...
                                <FieldSelectAsync name="transportista" clearable={true} />
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreateVehiculo" variant="primary" label="REG240_frm_btn_Actualizar" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
