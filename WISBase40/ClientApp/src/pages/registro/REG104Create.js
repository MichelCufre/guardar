...
export default function REG104Create(props) {
    ...
    return (
        <Page
            {...props}
            application="REG104Create"
        >
            <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
                <Form
                    application="REG104Create"
                    id="REG104Create_form_1"
                    validationSchema={validationSchema}
                    onAfterSubmit={handleFormAfterSubmit}
                >
                    <Modal.Header closeButton>
                        <Modal.Title>{t("REG104_Sec0_modalTitle_RegistroZona")}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Container fluid>
                            <Row>
                    ...
                    <Modal.Footer>
                        ...
                        <SubmitButton id="btnCrearZona" label="REG104_frm1_btn_Guardar" variant="primary" className="mt-2" />
                    </Modal.Footer>
                </Form>
            </Modal >
        </Page >
