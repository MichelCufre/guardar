...
export default function POR010(props) {
    ...
    const GridShowClassName = isShowGrid ? "row mb-4" : "hidden";
    ...
    const [trajoDatosAgenda, setTrajoDatosAgenda] = useState(false);
    ...
    const onGoNextTab = (nexus) => {
        ...
        if (currentTab === "tabTipoRegistro") {
            ...
            nexus.getForm("POR010_form_1").setFieldValue("CURRENT", "tabDatosVehiculo");
        }
        else if (currentTab === "tabDatosVehiculo") {
            nexus.getGrid("POR010_grid_Personas").refresh();
            setCurrentTab("tabDatosGenerales")
            nexus.getForm("POR010_form_1").setFieldValue("CURRENT", "tabDatosGenerales");
        }
        else if (currentTab === "tabDatosGenerales") {
            setCurrentTab("tabAsociarContactos")
            nexus.getForm("POR010_form_1").setFieldValue("CURRENT", "tabAsociarContactos");
        }
    ...
    const onGoTabDatosVehiculo = (nexus, type) => {
        ...
        let form = nexus.getForm("POR010_form_1");
    ...
    const onGoPreviusTab = (nexus) => {
        ...
        if (currentTab === "tabDatosVehiculo") {
            nexus.getForm("POR010_form_1").reset();
        }
        else if (currentTab === "tabDatosGenerales") {
            setCurrentTab("tabDatosVehiculo");
            nexus.getForm("POR010_form_1").setFieldValue("CURRENT", "tabDatosVehiculo");
    ...
    const formOnBeforeButtonAction = (context, form, query, nexus) => {
        ...
        if (query.buttonId === "btnOpenForm") {
            ...
            nexus.getGrid("POR010_grid_Personas").reset();
            setIsShowForm(true);
        }
    ...
    const onAfterValidateField = (context, form, query, nexus) => {
        ...
        if (query.fieldId === "VL_MATRICULA_1_ENTRADA") {
            let personas = query.parameters.find(w => w.id === "SelectionGridPersonas").value;

            if (personas != ""){
                setSelectionGridPersonas(personas);
            }
    ...
    return (
        ...
        <Page
            title={t("POR010_Sec0_pageTitle_Titulo")}
            {...props}
        >
            ...
            >
                ...
                >
                    ...
                    <FormTabStep id="tabAsociarContactos" label="POR010_frm1_lbl_tabAsociarContactos">
                        ...
                        <Row>
                            <Col>
                                <Grid id="POR010_grid_Personas" rowsToFetch={10} rowsToDisplay={10}
...
//<div className="row mb-4 notModeTablet">
//    <div className="col-12">

//        <Grid id="POR010_grid_1" rowsToFetch={30} rowsToDisplay={15} enableExcelExport
