...
function InternalPRE811UpdatePreferenciaModal(props) {
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-70w" backdrop="static">
            <Form
                application="PRE811UpdatePreferencia"
                id="PRE811Update_form_1"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("PRE811_Sec0_mdlUpdate_Titulo")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col className="col-3">
                            <div className="form-group" >
                                <label htmlFor="nuPreferencia">{t("PRE811_frm1_lbl_nuPreferencia")}</label>
                                <Field name="nuPreferencia" disabled />
                                <StatusMessage for="nuPreferencia" />
                            </div>
                        </Col>
                        <Col className="col-3">
                            <div className="form-group" >
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreatePreferencia" variant="primary" label="PRE811_frm1_btn_ACTUALIZAR" />
...
export const PRE811UpdatePreferenciaModal = withPageContext(InternalPRE811UpdatePreferenciaModal);