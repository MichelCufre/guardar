...
export default function PRE110DetPedidoLpnAtr(props) {
    ...
    return (
        ...
        <Page
            title={t("PRE110DetPedidoAtr_Sec0_pageTitle_Titulo")}
            {...props}
        >
            <Modal.Header closeButton>
                <Modal.Title>{t("PRE110DetPedidoAtr_Sec0_pageTitle_Titulo")}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
            <div className="row mb-3">
                <div className="col-12">
                        <Grid id="PRE110DetPedidoAtr_grid_1"
                            application="PRE110DetPedidoAtr"
