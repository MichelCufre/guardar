...
export default function PRE100DefinicionAtributo(props) {
    ...
    useEffect(() => {
        if (nexus && props.listAtributos && nexus.getForm("PRE100DefinicionAtributo_form_1")) {
            nexus.getForm("PRE100DefinicionAtributo_form_1").reset();
        }
    }, [props.listAtributos]);
    ...
    return (
        <Modal show={props.show} onHide={handleClose} backdrop="static">
            ...
            <Page
                {...props}
                application="PRE100DefinicionAtributo"
            /*onBeforeLoad={onBeforeLoad}*/
            >
                <Form
                    application="PRE100DefinicionAtributo"
                    id="PRE100DefinicionAtributo_form_1"
