...
function InternalPRE810EditarPonderadorRutas(props) {
    ...
    const onAfterMenuItemAction = (context, data, nexus) => {
        nexus.getGrid("PRE810PonderacionRuta_grid_1").refresh();
    };
    ...
    return (
        <Modal dialogClassName="modal-50w" show={props.show} onHide={props.onHide} >
            <Modal.Header closeButton>
                <Modal.Title>{t("PRE810_Sec0_lbl_Title_CD_ROTA")}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Page
                    load
                ...
                >
                    <Grid
                        id="PRE810PonderacionRuta_grid_1"
                        application="PRE810PonderadorRuta"
                        rowsToFetch={30}
                        rowsToDisplay={10}
...
export const PRE810EditarPonderadorRutas = withPageContext(InternalPRE810EditarPonderadorRutas);