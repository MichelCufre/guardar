...
function InternalPRE810EditarPonderadorCondLiberacion(props) {
    ...
    const onAfterMenuItemAction = (context, data, nexus) => {
        nexus.getGrid("PRE810CondicionLiberacion_grid_1").refresh();
    };
    ...
    return (
        <Modal dialogClassName="modal-50w" show={props.show} onHide={props.onHide} >
            <Modal.Header closeButton>
                <Modal.Title>{t("PRE810_Sec0_lbl_Title_CON_LIB")}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Page
                    load
                ...
                >
                    <Grid
                        id="PRE810CondicionLiberacion_grid_1"
                        application="PRE810CondicionLiberacion"
                        rowsToFetch={30}
                        rowsToDisplay={10}
...
export const PRE810EditarPonderadorCondLiberacion = withPageContext(InternalPRE810EditarPonderadorCondLiberacion);