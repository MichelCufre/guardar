...
export function EVT060CreatePlantillaModal(props) {
    ...
    useEffect(() => {
        if (nexus) {
            var form = nexus.getForm("EVT060CreatePlantilla_form1");
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                id="EVT060CreatePlantilla_form1"
                application="EVT060CreatePlantilla"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("EVT060CreatePlantilla_Sec0_modalTitle_Create")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col md={6}>
                            <div className="form-group">
                                <label htmlFor="codigoPlantilla">{t("EVT060CreatePlantilla_frm1_lbl_codigoPlantilla")}</label>
                        ...
                        <Col md={6}>
                            <div className="form-group">
                                <label htmlFor="descripcionPlantilla">{t("EVT060CreatePlantilla_frm1_lbl_descripcionPlantilla")}</label>
                    ...
                    <Row>
                        <Col md={6}>
                            <div className="form-group">
                                <label htmlFor="codigoEvento">{t("EVT060CreatePlantilla_frm1_lbl_codigoEvento")}</label>
                        ...
                        <Col md={6}>
                            <div className="form-group">
                                <label htmlFor="tipoNotificacion">{t("EVT060CreatePlantilla_frm1_lbl_tipoNotificacion")}</label>
                    ...
                    <Row>
                        <Col md={9}>
                            <div className="form-group">
                                <label htmlFor="asuntoNotificacion">{t("EVT060CreatePlantilla_frm1_lbl_asuntoNotificacion")}</label>
                        ...
                        <Col md={3} className="align-self-center">
                            <div className="form-group">
                                <FieldToggle name="habilitarHtml" label={t("EVT060CreatePlantilla_frm1_lbl_habilitarHtml")} />
                    ...
                    <Row>
                        <Col lg={habilitarHtml ? 6 : 12}>
                            <label htmlFor="cuerpoNotificacion">{t("EVT060CreatePlantilla_frm1_lbl_cuerpoNotificacion")}</label>
                        ...
                        <Col lg={6} className={habilitarHtml ? '' : 'hidden'}>
                            <label htmlFor="previewCuerpoNotificacion">{t("EVT060CreatePlantilla_frm1_lbl_previewCuerpoNotificacion")}</label>
                ...
                <Modal.Footer>
                    <Button variant="outline-secondary" onClick={handleClose}>
                        {t("EVT060CreatePlantilla_frm1_btn_cancelar")}
                    </Button>
                    <SubmitButton id="btnSubmitCreatePlantilla" variant="primary" label="EVT060CreatePlantilla_frm1_btn_crear" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
