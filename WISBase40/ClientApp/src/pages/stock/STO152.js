...
import { Modal, Row, Col, FormGroup, Button, Tab, Tabs, Container } from 'react-bootstrap';
...
export default function STO152(props) {
    ...
    const addParameters = (context, data, nexus) => {
        data.parameters = [
            {
                id: "CD_CONTROL",
                value: nexus.getForm("STO152_form_1").getFieldValue("CD_CONTROL") || ""
            }
        ];
    };

    const handleGridAfterMenuItemAction = (context, data, nexus) => {
        nexus.getGrid("STO152_grid_1").refresh();
    }
    ...
    const onAfterSubmit = (context, form, query, nexus) => {
        ...
        nexus.getGrid("STO152_grid_1").clickMenuItem("BtnConfirmar");
    ...
    return (
        <Page
            icon="fas fa-cubes"
            title={t("STO152_Sec0_pageTitle_Titulo")}
            {...props}
        >
                    ...
                    <Row>
                        <Col>
                            <Row>
                                <Col>
                                    <FormGroup>
                                        <label htmlFor="CD_CONTROL">{t("STO152_frm1_lbl_CD_CONTROL")}</label>
                                ...
                                <Col>
                                    <Col>
                                        <FormGroup>
                                            <br />
                                            <SubmitButton id="BtnConfirmar" variant="primary" className="ml-2 mr-5" label="STO152_Sec0_btn_ConfirmarControl" />
                                        </FormGroup>
                                    </Col>
                                </Col>
                            </Row>
