...
export function STO800UpdateConfiguracionModal(props) {
    ...
    const handleFormBeforeInitialize = (context, form, query, nexus) => {
        query.parameters = [{ id: "idConfig", value: props.config }];
    }
    ...
    const onBeforeSubmit = (context, form, query, nexus) => {
        query.parameters.push({ id: "idConfig", value: props.config });
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                id="STO800_form_UpdateConfig"
                application="STO800ModificarConfiguracion"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("STO800_Sec0_modalTitle_Update")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col>
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitUpdateConfig" variant="primary" label="STO800_frm1_btn_Modificar" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
