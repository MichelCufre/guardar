...
export function STO810CreateMapeoModal(props) {
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                id="STO810_form_CreateMapeo"
                application="STO810CrearMapeo"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{t("STO810_Sec0_modalTitle_Titulo")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col md={6}>
                ...
                <Modal.Footer>
                    ...
                    <SubmitButton id="btnSubmitCreateMapeo" variant="primary" label="STO810_frm1_btn_Crear" />
                </Modal.Footer>
            </Form>
        </Modal>
    );
