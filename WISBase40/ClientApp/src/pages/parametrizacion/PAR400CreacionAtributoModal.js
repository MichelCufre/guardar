...
function InternalPAR400CreacionAtributoModal(props) {
    ...
    const onAfterValidateField = (context, form, query, nexus) => {
        ...
        const tipo = query.parameters.find(p => p.id === "tipo");
    ...
    return (
        ...
        <Form
            application="PAR400CrearAtributo"
            id="PAR400CrearAtributo_form_1"
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title>{t("PAR400_Sec0_mdlEdit_Crear")}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Container fluid>
                    <Row>
...
export const PAR400CreacionAtributoModal = withPageContext(InternalPAR400CreacionAtributoModal);