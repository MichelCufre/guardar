...
export default function INT100Modal(props) {
    ...
    return (
        <Modal show={props.show} onHide={props.onHide} dialogClassName="modal-90w">
            <Modal.Header closeButton>
                <Modal.Title>{t("INT100Modal_Sec0_modalTitle_Titulo") + " " + nuInterfaz}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className="row mb-4">
                    <div className="col-12">
                        <Grid id="INT100Modal_grid_1"
                            application="INT100Modal"
