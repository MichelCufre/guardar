...
import INT100Modal from './INT100Modal';

export default function INT100(props) {
    ...
    return (
        <Page
            title={t("INT100_Sec0_pageTitle_Titulo")}
            {...props}
        >
            <Container fluid>
                <Row>
            ...
            />
            <INT100Modal show={showModal} onHide={onHide} nuInterfaz={nuInterfazEjecucion} />
        </Page>
    );
}