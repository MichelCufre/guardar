...
import INT107Modal from './INT107Modal';

export default function INT107(props) {
    ...
    return (
        <Page
            title={t("INT107_Sec0_pageTitle_Titulo")}
            {...props}
        >
            <Container fluid>
                <Row>
                    ...
                    {/* <Col>
                        <Row>
                            <Col sm={3}>
                                <span style={{ fontWeight: "bold" }}>{t("INT107_frm1_lbl_DS_REFERENCIA")}:</span>
                            </Col>
                            <Col className='p-0'>
            ...
            />
            <INT107Modal show={showModal} onHide={onHide} nuInterfaz={nuInterfazEjecucion} />
        </Page>
    );
}