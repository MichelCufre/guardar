...
function InternalImpresionUTModal(props) {
    ...
    const onBeforeValidateField = (context, form, query, nexus) => {
        ...
        query.parameters.push({ id: "reimprimirEtiquetas", value: valor });
    }

    const onBeforeSubmit = (context, form, query, nexus) => {

        if (props.selectedKeys) {
            query.parameters = [{ id: "selectedKeys", value: props.selectedKeys }];
        };
        ...
        query.parameters.push(
            { id: "reimprimirEtiquetas", value: valor },
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                application="IMP200ImpresionUT"
                id="IMP200ImpresionUT_form_1"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{reimprimir ? t("IMP200_Sec0_mdl_Title_ReImprimir") : t("IMP200_Sec0_mdl_Title_Imprimir")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container fluid>
                        <Row>
                        ...
                        <Row style={{ display: reimprimir ? 'block' : 'none' }}>
                            <Col>
                                <div className="form-group" >
...
export const IMP200ImpresionUTModal = withPageContext(InternalImpresionUTModal);
