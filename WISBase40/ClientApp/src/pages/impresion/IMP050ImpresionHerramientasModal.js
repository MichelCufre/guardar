...
function InternalImpresionHerramientasModal(props) {
    ...
    return (
        <Modal show={props.show} onHide={handleClose} dialogClassName="modal-50w" backdrop="static">
            <Form
                application="IMP050Herramientas"
                id="IMP050Herramientas_form_1"
            ...
            >
                ...
                <Modal.Header closeButton>
                    <Modal.Title>{t("IMP050_Sec0_mdl_herramientas_Titulo")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container fluid>
                        <Row>
...
export const IMP050ImpresionesHerramientaModal = withPageContext(InternalImpresionHerramientasModal);
