...
class InternalCellDate extends Component {
    constructor(props) {
        super(props);
            ...
            if (this.props.editing) {
                return (
                    <DatePicker
                        ...
                        customInput={
                            <CellDateInput ref={this.inputRef} mask="99/99/9999" clearCell={this.clearCell} setIgnoreNextUpdate={this.setIgnoreNextUpdate} totallyNotAutofocus={true} />
                        }
                    />
                );
            }
...
export const CellDate = withKeyNavigation(InternalCellDate);