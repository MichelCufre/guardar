...
namespace WIS.Domain.General.API.Dtos.Salida
{
    public class AlmacenamientoResponse
    {
        ...
        public List<DetalleAlmacenamientoResponse> Detalles { get; set; }

        public AlmacenamientoResponse()
        {
            Detalles = new List<DetalleAlmacenamientoResponse>();
        }
    }

    public class DetalleAlmacenamientoResponse
    {
        /// <summary>
