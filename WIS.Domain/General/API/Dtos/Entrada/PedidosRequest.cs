...
{
    public class PedidosRequest : IApiEntradaRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <example>Creación de pedidos</example>
        [ApiDtoExample("Creación de pedidos")]
        [RequiredValidation]
        ...
        {
            Pedidos.Add(item as PedidoRequest);
        }
    }

    public class PedidoRequest : IApiEntradaItemRequest
    {
        /// <summary>
        ...
        public List<PedidoLpnRequest> Lpns { get; set; }

        public List<DetallePedidoRequest> Detalles { get; set; }

        public PedidoRequest()
        {
            Lpns = new List<PedidoLpnRequest>();
            Detalles = new List<DetallePedidoRequest>();
        }
    }

    public class PedidoLpnRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Tipo de Lpn.
        /// En caso de no enviar un valor se tomará el del parámetro de configuración IE_535_TP_LPN_TIPO. 
        /// </summary>
        /// <example>1</example>
        [ApiDtoExample("1")]
    ...
    public class DetallePedidoRequest
    {
        ...
        public List<DetallePedidoDuplicadoRequest> Duplicados { get; set; }

        public List<DetallePedidoLpnRequest> DetallesLpn { get; set; }

        public List<DetallePedidoAtributosRequest> Atributos { get; set; }

        public DetallePedidoRequest()
        {
            Duplicados = new List<DetallePedidoDuplicadoRequest>();
            DetallesLpn = new List<DetallePedidoLpnRequest>();
            Atributos = new List<DetallePedidoAtributosRequest>();
        }
    }

    public class DetallePedidoDuplicadoRequest
    {
        /// <summary>
    ...
    public class DetallePedidoLpnRequest
    {
        /// <summary>
        ...
        [SwaggerIgnore]
        public List<DetallePedidoLpnAtributosRequest> Atributos { get; set; }

        public DetallePedidoLpnRequest()
        {
            Atributos = new List<DetallePedidoLpnAtributosRequest>();
        }
    }

    public class DetallePedidoAtributosRequest
    {
        /// <summary>
        /// Cantidad pedida del producto
        /// </summary>
        ...
        public List<DetallePedidoAtributoRequest> Atributos { get; set; }

        public DetallePedidoAtributosRequest()
        {
            Atributos = new List<DetallePedidoAtributoRequest>();
        }
    }

    public class DetallePedidoAtributoRequest
    {
        /// <summary>
        /// Nombre del atributo.
        /// </summary>
    ...
    public class DetallePedidoLpnAtributosRequest
    {
        /// <summary>
        /// Cantidad pedida del producto
        /// </summary>
        ...
        public List<DetallePedidoLpnAtributoRequest> Atributos { get; set; }

        public DetallePedidoLpnAtributosRequest()
        {
            Atributos = new List<DetallePedidoLpnAtributoRequest>();
        }
    }

    public class DetallePedidoLpnAtributoRequest
    {
        /// <summary>
        /// Nombre del atributo.
        /// </summary>
