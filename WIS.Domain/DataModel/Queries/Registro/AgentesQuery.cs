...
{
    public class AgentesQuery : QueryObject<V_REG220_AGENTES, WISDB>
    {
        ...
        public AgentesQuery(string idCliente, int? idEmpresa)
        {
        ...
        {
            this.Query = context.V_REG220_AGENTES.Select(d => d);
