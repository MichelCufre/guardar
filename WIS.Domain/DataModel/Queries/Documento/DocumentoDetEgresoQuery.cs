...
{
    public class DocumentoDetEgresoQuery : QueryObject<V_LT_DET_DOCUMENTO_EGRESO, WISDB>
    {
        ...
        public DocumentoDetEgresoQuery(string producto, string lote, decimal faixa, int empresa, string nuDocumento, string tpDocumento)
        {
        ...
        {
            this.Query = context.V_LT_DET_DOCUMENTO_EGRESO
