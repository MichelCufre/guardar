...
{
    public class DetallesIngresoQuery : QueryObject<V_DET_DOCUMENTO_INGRESO, WISDB>
    {
        protected readonly string _nuDocumento;
        protected readonly string _tpDocumento;

        public DetallesIngresoQuery()
        {

        }

        public DetallesIngresoQuery(string nuDocumento, string tpDocumento)
        {
        ...
        {
            this.Query = context.V_DET_DOCUMENTO_INGRESO;
