...
{
    public class InventarioConsultaAtributosDetalleLpnDetQuery : QueryObject<V_INV410_ATRIBUTO, WISDB>
    {
        protected Dictionary<int, string> _atributos;

        public InventarioConsultaAtributosDetalleLpnDetQuery()
        {
        ...
        {
            this.Query = context.V_INV410_LPN_DET_ATRIBUTO_DET
