...
{
    public class ConsultaAtributosLpnQuery : QueryObject<V_STO740_ATRIBUTO, WISDB>
    {
        protected Dictionary<int, string> _atributos;
        protected string _tipo;

        public ConsultaAtributosLpnQuery(string tipo)
        { 
            _atributos = new Dictionary<int, string>();
            _tipo = tipo;
        }

        public ConsultaAtributosLpnQuery(string tipo, Dictionary<int, string> atributos)
        {
        ...
        {
            this.Query = context.V_STO740_LPN_DET_ATRIBUTO_CAB
