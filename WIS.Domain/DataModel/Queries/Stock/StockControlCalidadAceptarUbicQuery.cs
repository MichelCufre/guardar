...
{
    public class StockControlCalidadAceptarUbicQuery : QueryObject<V_STO060_CTR_CALIDAD_UBIC, WISDB>
    {
        public override void BuildQuery(WISDB context)
        {
            this.Query = context.V_STO060_CTR_CALIDAD_UBIC.Where(x => x.ID_ACEPTADO == "N"); ;
        }
