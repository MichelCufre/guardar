...
{
    public class PedidoProductoContenedorQuery : QueryObject<V_PEDIDO_PRODUTO_CONTENEDOR, WISDB>
    {
        protected readonly PedidoProductoContenedorQueryData _queryData;

        public PedidoProductoContenedorQuery(PedidoProductoContenedorQueryData queryData)
        {
        ...
        {
            this.Query = context.V_PEDIDO_PRODUTO_CONTENEDOR
                .AsNoTracking()
    ...
    public class PedidoProductoContenedorQueryData
    {
