...
{
    public class ArmarCamionCargaQuitarQuery : QueryObject<V_EXP010_CARGA_CAMION, WISDB>
    {
        protected readonly int _camion;
        protected readonly int? _empresa;
        protected readonly short? _ruta;

        public ArmarCamionCargaQuitarQuery(int camion, int? empresa = null, short? ruta = null)
        {
            this._camion = camion;
        ...
        {
            this.Query = context.V_EXP010_CARGA_CAMION.Where(d => (d.CD_CAMION == this._camion || d.CD_CAMION == null) && d.ID_CARGAR == "S");
