...
{
    public class AgregarTpPedidoPreferenciaQuery : QueryObject<V_PRE811_PREF_TP_PEDIDO, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarTpPedidoPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_TP_PEDIDO.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_TP_PEDIDO == null);
        }
