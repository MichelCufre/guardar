...
{
    public class QuitarCondLibPreferenciaQuery : QueryObject<V_PRE811_PREF_COND_LIB, WISDB>
    {
        protected readonly int _preferencia;

        public QuitarCondLibPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_COND_LIB.AsNoTracking().Where(d => d.NU_PREFERENCIA_COND_LIB != null && d.NU_PREFERENCIA_COND_LIB == this._preferencia);
        }
