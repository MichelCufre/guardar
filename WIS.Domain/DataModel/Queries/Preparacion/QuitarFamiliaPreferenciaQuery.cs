...
{
    public class QuitarFamiliaPreferenciaQuery : QueryObject<V_PRE811_PREF_FAMILIA, WISDB>
    {
        protected readonly int _preferencia;

        public QuitarFamiliaPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_FAMILIA.AsNoTracking().Where(d => d.NU_PREFERENCIA_FAMILIA != null && d.NU_PREFERENCIA_FAMILIA == this._preferencia);
        }
