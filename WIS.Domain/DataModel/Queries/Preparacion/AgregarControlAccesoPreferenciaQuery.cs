...
{
    public class AgregarControlAccesoPreferenciaQuery : QueryObject<V_PRE811_PREF_CONT_ACCESO, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarControlAccesoPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_CONT_ACCESO.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_CONT_ACCESO == null);
        }
