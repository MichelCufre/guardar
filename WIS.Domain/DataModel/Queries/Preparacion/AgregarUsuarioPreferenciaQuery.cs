...
{
    public class AgregarUsuarioPreferenciaQuery : QueryObject<V_PRE811_PREF_USUARIO, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarUsuarioPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_USUARIO.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_USUARIO == null);
        }
