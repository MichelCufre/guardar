...
{
    public class AgregarTpExpedicionPreferenciaQuery : QueryObject<V_PRE811_PREF_TP_EXP, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarTpExpedicionPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_TP_EXP.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_TP_EXP == null);
        }
