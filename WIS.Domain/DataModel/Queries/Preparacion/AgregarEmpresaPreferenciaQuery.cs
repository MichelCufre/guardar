...
{
    public class AgregarEmpresaPreferenciaQuery : QueryObject<V_PRE811_PREF_EMPRESA, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarEmpresaPreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_EMPRESA.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_EMPRESA == null);
        }
