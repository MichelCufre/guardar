...
{
    public class DetallePedidoAtributosNoAsociadosQuery : QueryObject<V_PRE100_ATRIBUTOS_SIN_DEFINIR, WISDB>
    {
        protected readonly DetallePedidoLpnEspecifico _datos;

        public DetallePedidoAtributosNoAsociadosQuery(DetallePedidoLpnEspecifico datos)
        {
            this._datos = datos;
        }
        ...
        {
            var idAtributosDefinidos = context.V_PRE100_ATRIBUTOS_DEFINIDOS
                            .AsNoTracking()
            ...
            this.Query = context.V_PRE100_ATRIBUTOS_SIN_DEFINIR
        ...
        public virtual List<string[]> GetSelectedKeys(List<string> keysToSelect)
        {
            return this.GetResult()
                .Select(r => string.Join("$", new string[] { r.ID_ATRIBUTO.ToString(), r.FL_CABEZAL }))
