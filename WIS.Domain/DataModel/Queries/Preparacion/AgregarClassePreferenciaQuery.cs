...
{
    public class AgregarClassePreferenciaQuery : QueryObject<V_PRE811_PREF_CLASSE, WISDB>
    {
        protected readonly int _preferencia;

        public AgregarClassePreferenciaQuery(int preferencia)
        {
        ...
        {
            this.Query = context.V_PRE811_PREF_CLASSE.AsNoTracking().Where(d => d.NU_PREFERENCIA == this._preferencia && d.NU_PREFERENCIA_CLASSE == null);
        }
