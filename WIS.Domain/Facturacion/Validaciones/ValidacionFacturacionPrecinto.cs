...
{
    public class ValidacionFacturacionPrecinto : IFacturacionValidacion
    {
        ...
        public ValidacionFacturacionPrecinto(IUnitOfWork uow, IValidacionFacturacionResultFormatResolver resolver)
        {
            this._uow = uow;
        ...
        {
            if (this._uow.PreparacionRepository.AnyContenedorSinPrecinto(camion.Id, pedido.Empresa, pedido.Cliente, pedido.Id))
