...
{
    public class DesarmadoEgresoPedido
    {
        protected readonly Camion _camion;
        protected readonly IUnitOfWork _uow;
        protected readonly List<PedidoAsociarUnidad> _pedidosDesasociar;
        ...
        public DesarmadoEgresoPedido(IUnitOfWork uow,
            IFactoryService factoryService,
            IIdentityService identity,
            Camion camion,
            ExpedicionConfiguracionService expedicionService,
            List<PedidoAsociarUnidad> pedidos)
        {
            this._uow = uow;
            this._factoryService = factoryService;
            this._identity = identity;
            this._camion = camion;
            this._pedidosDesasociar = pedidos;
        ...
        public virtual void Desarmar()
        {
            ...
            _uow.CamionRepository.DesasociarPedidosCamion( _uow, _camion, _pedidosDesasociar);
