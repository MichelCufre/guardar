...
{
    public class AnularPickingPedidoPendienteContext : ServiceContext, IAnularPickingPedidoPendienteContext
    {
        protected List<AnularPickingPedidoPendiente> _detalles = new List<AnularPickingPedidoPendiente>();
        ...
        public AnularPickingPedidoPendienteContext(IUnitOfWork uow,List<AnularPickingPedidoPendiente> detalles,int userId, int empresa) : base(uow, userId, empresa)
        {
            _detalles = detalles;
        }
