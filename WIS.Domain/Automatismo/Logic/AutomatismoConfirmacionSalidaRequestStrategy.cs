...
{
    public class AutomatismoConfirmacionSalidaRequestStrategy : IAutomatismoRequestStategy
    {
        ...
        protected readonly List<ConfirmacionSalidaStockRequest> _records;
        ...
        public AutomatismoConfirmacionSalidaRequestStrategy(
            ...
            AutomatismoEjecucion ejecucion)
        {
            ...
            {
                new SortCommand("IdSalida", SortDirection.Descending)
            };
            ...
            _records = new List<ConfirmacionSalidaStockRequest>
            {
                GetAutomatismoRequest<ConfirmacionSalidaStockRequest>()
            };
        }
        ...
        public virtual void UpdateRequest(GridRow row, GridFetchContext context)
        {
            ...
            var automatismoRequest = GetAutomatismoRequest<ConfirmacionSalidaStockRequest>();

            if (context.Parameters.Any(i => i.Id == "SHOW_DETAILS_GRID"))
            {
                if (int.TryParse(row.GetCell("IdLinea").Value, out int idLineaSalida))
                {
                    var detail = automatismoRequest.Detalles.FirstOrDefault(i => i.IdLinea == idLineaSalida);
        ...
        public virtual List<ConfirmacionSalidaStockLineaRequest> GetDetalles()
        {
            var records = new List<ConfirmacionSalidaStockLineaRequest>();
