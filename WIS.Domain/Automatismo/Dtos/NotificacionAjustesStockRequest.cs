...
{
    public class NotificacionAjustesStockRequest : IApiAutomatismoRequest
    {
        /// <summary>
        ...
        public List<AutomatismoAjusteStockRequest> Ajustes { get; set; }

        public NotificacionAjustesStockRequest()
        {
        ...
        {
            Ajustes.Add(item as AutomatismoAjusteStockRequest);
        }
    }

    public class AutomatismoAjusteStockRequest : IApiAutomatismoItemRequest
    {
