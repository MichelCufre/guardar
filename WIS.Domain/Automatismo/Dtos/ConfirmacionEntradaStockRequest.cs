...
{
    public class ConfirmacionEntradaStockRequest : IApiAutomatismoRequest
    {
        /// <summary>
        ...
        /// Lista de detalles
        /// </summary>
        public List<ConfirmacionEntradaStockLineaRequest> Detalles { get; set; }

        public ConfirmacionEntradaStockRequest()
        {
        ...
        {
            Detalles.Add(item as ConfirmacionEntradaStockLineaRequest);
        }
    }

    public class ConfirmacionEntradaStockLineaRequest : IApiAutomatismoItemRequest
    {
