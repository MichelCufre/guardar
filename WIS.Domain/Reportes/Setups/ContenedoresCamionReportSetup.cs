...
{
    public class ContenedoresCamionReportSetup : IReportSetup
    {
        ...
        protected readonly string _tipoReporte = CReporte.CONTENEDORES_CAMION;
        ...
        public ContenedoresCamionReportSetup(IUnitOfWork uow, IParameterService parameterService, IReportKeyService keyResolver, IIdentityService securityService, Camion camion, string predio = null)
        {
            this._uow = uow;
        ...
        public ContenedoresCamionReportSetup(IUnitOfWork uow)
        {
        ...
        public virtual void GenerarReporte(IUnitOfWork uow, DbConnection connection, ILogger<ReportLogic> logger, DtoReporteRelacion relacion)
        {
            ...
            {
                logger.LogDebug(ex, $"GenerarReporteContenedoresCamion - Clave: " + relacion.Clave);
        ...
        public virtual void Generar(IUnitOfWork uow, DbConnection connection, int cdCamion, int cdEmpresa, string cdCliente, string language, out byte[] fileData, out string fileName)
        {
            ...
            var datos = uow.ReporteRepository.GetInfoContenedoresCamion(connection, cdCamion);
            var detalles = uow.ReporteRepository.GetInfoContenedoresCamionDet(connection, cdCamion, cdEmpresa, cdCliente);
            ...
            {
                "WCOF070_ReporteCC_lbl_CD_CLIENTE",
                "WCOF070_ReporteCC_lbl_CD_CAMION",
                "WCOF070_ReporteCC_lbl_CD_PLACA_CARRO",
                "WCOF070_ReporteCC_lbl_CD_TRANSPORTADORA",
                "WCOF070_ReporteCC_lbl_DT_CIERRE",
                "WCOF070_ReporteCC_lbl_CD_EMPRESA",
                "WCOF070_ReporteCC_lbl_Pagina",
                "WCOF070_ReporteCC_lbl_SeparadorPagina",
                "WCOF070_ReporteCC_lbl_DS_TIPO_CONTENEDOR",
                "WCOF070_ReporteCC_lbl_QT_TIPO_CONTENEDOR"
            }, language);
            ...
            if (datos != null && detalles.Any())
            {
                ...
                CreateContent(doc, resourceList, detalles);
        ...
        public virtual void CreateHeader(Document doc, List<TranslatedValue> resourceList, DtoReporteContCamion datos, DtoReporteContCamionDet datosCliente, string filePath, bool reporteConLogo)
        {
            if (reporteConLogo)
            {
            ...
            var head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_CD_CAMION")?.Value ?? "Camión").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_CD_CLIENTE")?.Value ?? "Agente").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            head.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
            head.SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            table.AddCell(head);
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_CD_PLACA_CARRO")?.Value ?? "Matrícula").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            head.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
            head.SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            table.AddCell(head);
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_CD_EMPRESA")?.Value ?? "Empresa").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            head.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
            head.SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            table.AddCell(head);
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_DT_CIERRE")?.Value ?? "Fecha cierre").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            head.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
            head.SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            table.AddCell(head);
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_CD_TRANSPORTADORA")?.Value ?? "Transportista").SetFontColor(ColorConstants.BLACK).SetPaddingLeft(10));
            head.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
            head.SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            table.AddCell(head);
        ...
        public virtual void CreateContent(Document doc, List<TranslatedValue> resourceList, List<DtoReporteContCamionDet> detalles)
        {
            ...
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_DS_TIPO_CONTENEDOR")?.Value ?? "Tipo de Contenedor").SetFontColor(ColorConstants.BLACK).SetTextAlignment(TextAlignment.CENTER));
            ...
            head = new Cell();
            head.Add(new Paragraph(resourceList.FirstOrDefault(x => x.Key == "WCOF070_ReporteCC_lbl_QT_TIPO_CONTENEDOR")?.Value ?? "Cant. de tipos").SetFontColor(ColorConstants.BLACK).SetTextAlignment(TextAlignment.CENTER));
            head.SetBorder(Border.NO_BORDER);
            head.SetBackgroundColor(ColorConstants.GRAY);
            ...
            foreach (var linea in detalles)
            {
                ...
                cell = new Cell();
                cell.Add(new Paragraph((linea.CantidadTipoContenedor ?? 1).ToString()));
                cell.SetBorder(new SolidBorder(ColorConstants.BLACK, 1));
        ...
        public virtual void Notificar(IUnitOfWork uow, long nuReporte, int cdCamion, int cdEmpresa, string cdCliente, string language, byte[] fileData, string fileName)
        {
            ...
            var instancias = uow.EventoRepository.GetInstanciasHabilitadas(EventoDb.ContenedoresCamion, new Dictionary<string, string>
            {
        ...
        public virtual List<long> Preparar()
        {
            ...
            foreach (var empresa in empresas)
            {
                ...
                if (string.IsNullOrEmpty(reportes) || !reportes.Contains($"\"{CReporte.CONTENEDORES_CAMION}\""))
                    continue;
