...
{
    public class ProduccionDocumentalRequest
    {
        public string NroProduccion { get; set; }
        ...
        public ProduccionDocumentalRequest()
        {
        ...
        public void AddLineaEgreso(int preparacion, int codigoEmpresa, string codigoProducto, string identificador, decimal? faixa, decimal? cantidadAfectada, string semiacabado, string consumible)
        {
            ...
            LineaEgresoDocumentalRequest linea = LineasEgreso.FirstOrDefault(s => s.Empresa == codigoEmpresa
