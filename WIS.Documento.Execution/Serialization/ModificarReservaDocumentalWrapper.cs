...
{
    public class ModificarReservaDocumentalWrapper : TransferWrapper, IModificarReservaDocumentalWrapper
    {
        public override ISerializationBinder GetSerializationBinder()
        {
            return new CustomSerializationBinder(new List<Type> {
                 typeof(ModificarReservaDocumentalRequest),
                 typeof(ModificarReservaDocumentalResponse),
            });
        }
    }
}
