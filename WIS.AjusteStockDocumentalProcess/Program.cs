...
namespace WIS.AjusteStockDocumentalProcess
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    var app = serviceProvider.GetService<IAjusteStockDocumentalService>();
                    var settings = serviceProvider.GetService<IOptions<AjusteStockDocumentalSettings>>()?.Value;
        ...
        public static void SetIdentity(ServiceProvider serviceProvider)
        {
            ...
            manager.SetUser(new BasicUserData
            {
                Language = "es",
                UserId = -1
            }, "JobAjusteStockDoc", GeneralDb.PredioSinDefinir);
        }
        ...
        public static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.Configure<AjusteStockDocumentalSettings>(config.GetSection(AjusteStockDocumentalSettings.Position));
            ...
            services.AddScoped<IAjusteStockDocumentalService, AjusteStockDocumentalService>();
