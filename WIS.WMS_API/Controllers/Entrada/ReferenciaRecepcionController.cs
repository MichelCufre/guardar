...
namespace WIS.WMS_API.Controllers.Entrada
{
    ...
    public class ReferenciaRecepcionController : ControllerBaseExtension
    {
        ...
        public ReferenciaRecepcionController(ILogger<ReferenciaRecepcionController> logger,
        ...
        [SwaggerRequestType(typeof(ReferenciasRecepcionRequest))]
        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                var request = await GetRequest<ReferenciasRecepcionRequest>();
        ...
        /// <summary>
        ///     swagger_summary_referenciarecepcion_reprocess
        /// </summary>
        ...
        public async Task<IActionResult> Reprocess([FromBody] ReprocesamientoRequest request)
        {
            try
            {
                ...
                return await Create(JsonConvert.DeserializeObject<ReferenciasRecepcionRequest>(Encoding.UTF8.GetString(itfzData.Data)), itfz);
            }
            catch (Exception ex)
            {
                this._logger.LogError(ex, this.Url.ActionContext.ToString());
        ...
        private async Task<IActionResult> Create(ReferenciasRecepcionRequest request, InterfazEjecucion ejecucion)
        {
            try
            {
        ...
        /// <summary>
        ///     swagger_summary_referenciarecepcion_getreferencia
        /// </summary>
        /// <remarks>swagger_remarks_referenciarecepcion_getreferencia</remarks>
        ...
        /// <summary>
        ///     swagger_summary_referenciarecepcion_getreferenciabyid
        /// </summary>
        /// <remarks>swagger_remarks_referenciarecepcion_getreferenciabyid</remarks>
