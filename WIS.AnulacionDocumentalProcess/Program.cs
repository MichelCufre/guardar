...
namespace WIS.AnulacionDocumentalProcess
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    var app = serviceProvider.GetService<IAnulacionDocumentalService>();
                    var settings = serviceProvider.GetService<IOptions<AnulacionDocumentalSettings>>()?.Value;
        ...
        public static void SetIdentity(ServiceProvider serviceProvider)
        {
            ...
            manager.SetUser(new BasicUserData
            {
                Language = "es",
                UserId = -1
            }, "JobAnulDoc", GeneralDb.PredioSinDefinir);
        }
        ...
        public static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.Configure<AnulacionDocumentalSettings>(config.GetSection(AnulacionDocumentalSettings.Position));
            ...
            services.AddScoped<IAnulacionDocumentalService, AnulacionDocumentalService>();
