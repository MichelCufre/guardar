...
{
    [Route("api/REC/REC410SelecPos")]
    [ApiController]
    public class REC410SelecPosController : ControllerBase
    {
        private readonly IPageControllerInvocation _pageInvoker;
        private readonly IGridControllerInvocation _gridInvoker;
        private readonly IFormControllerInvocation _formInvoker;
        private readonly REC410SelecPos _controller;

        public REC410SelecPosController(
            IPageControllerInvocation pageInvoker,
            IGridControllerInvocation gridInvoker,
            IFormControllerInvocation formInvoker,
            REC410SelecPos controller)
        {
