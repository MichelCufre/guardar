...
using WIS.Security;
using WIS.TicketPrintingProcess.Services;

namespace WIS.TicketPrintingProcess
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    var app = serviceProvider.GetService<IApplicationControl>();
        ...
        public static void SetIdentity(ServiceProvider serviceProvider)
        {
            ...
            manager.SetUser(new BasicUserData
            {
                Language = "es",
                UserId = -1
            }, "JobTicketPrinting", GeneralDb.PredioSinDefinir);
        }
        ...
        public static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.AddScoped<IApplicationControl, ApplicationControl>();
