...
{
    public class CreateEventoTemplateFormValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IIdentityService _identity;
        protected readonly ISecurityService _security;

        public CreateEventoTemplateFormValidationModule(IUnitOfWork uow, IIdentityService identity, ISecurityService security)
        {
        ...
        public virtual FormValidationGroup ValidateCodigoPlantilla(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            return new FormValidationGroup
            {
                ...
                Rules = new List<IValidationRule>
                {
                   ...
                   new ExisteEventoTemplateValidationRule(this._uow, nuEvento, tpNotificacion, field.Value)
                },
