...
{
    public class EXP110ConfiguracionInicialValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly int _usuario;
        protected readonly string _predio;

        public EXP110ConfiguracionInicialValidationModule(IUnitOfWork uow, int usuarioLogueado, string predioLogueado)
        {
            this._uow = uow;
            ...
            this.Schema = new FormValidationSchema
            {
                ...
                ["ubicacion"] = this.ValidateUbicacion,
        ...
        #region Ubicacion
        public virtual FormValidationGroup ValidateUbicacion(FormField field, Form form, List<ComponentParameter> parameters)
        {
            return new FormValidationGroup
            {
                BreakValidationChain = true,
