...
{
    public class ImpresionesUbicacionValidationModule : FormValidationModule
    {
        ...
        public ImpresionesUbicacionValidationModule(IUnitOfWork uow, int usuarioLogueado, string predioLogueado, List<Ubicacion> ubicaciones = null)
        {
            this._uow = uow;
        ...
        public virtual void ValidatePredio_OnSucess(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            if (!parameters.Any(i => i.Id == "isSubmit"))
            {
        ...
        public virtual void ValidateImpresora_OnSucess(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            if (!parameters.Any(i => i.Id == "isSubmit"))
            {
                ...
                List<EtiquetaEstiloLenguaje> listaEstilos = _uow.ImpresionRepository.GetEstiloByLenguaje(lenguaje.Id, EstiloEtiquetaDb.Ubicacion);
        ...
        public virtual FormValidationGroup ValidateEstilo(FormField field, Form form, List<ComponentParameter> parameters)
        {
            return new FormValidationGroup
            {
                ...
                {
                    new NonNullValidationRule(field.Value),
                    new EstiloImpresionUbicacionValidationRule(_uow, field.Value, this._ubicaciones)
                }
            };
        }
