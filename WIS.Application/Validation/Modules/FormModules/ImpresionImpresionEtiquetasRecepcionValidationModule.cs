...
{
    public class ImpresionImpresionEtiquetasRecepcionValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IIdentityService _identity;

        public ImpresionImpresionEtiquetasRecepcionValidationModule(IUnitOfWork uow, IIdentityService identity)
        {
            this._uow = uow;
        ...
        public virtual void ValidateImpresora_OnSucess(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            if (!parameters.Any(s => s.Id == "isSubmit"))
            {
                ...
                List<EtiquetaEstiloLenguaje> listaEstilos = _uow.ImpresionRepository.GetEstiloByLenguaje(lenguaje.Id, EstiloEtiquetaDb.Recepcion);
