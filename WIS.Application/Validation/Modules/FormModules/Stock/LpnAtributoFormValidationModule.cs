...
{
    public class LpnAtributoFormValidationModule : FormValidationModule
    {
        ...
        public LpnAtributoFormValidationModule(IUnitOfWork uow, IIdentityService identity, ISecurityService security, IFormatProvider provider)
        {
            this._uow = uow;
        ...
        public virtual FormValidationGroup ValidateDominio(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            var requerido = (_uow.ManejoLpnRepository.GetLpnTipoAtributo(atributo.Id, tpLpnTipo).Requerido == "S");
