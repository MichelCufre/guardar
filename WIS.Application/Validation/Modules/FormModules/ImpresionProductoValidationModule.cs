...
{
    public class ImpresionProductoValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IIdentityService _identity;

        public ImpresionProductoValidationModule(IUnitOfWork uow, IIdentityService identity)
        {
            this._uow = uow;
            ...
            this.Schema = new FormValidationSchema
            {
                ...
                ["tipoCodigoBarra"] = this.ValidateTipoCodigoBarra
            };
        }
        ...
        public virtual FormValidationGroup ValidateTipoCodigoBarra(FormField field, Form form, List<ComponentParameter> parameters)
        {
            return new FormValidationGroup
            {
                BreakValidationChain = true,
