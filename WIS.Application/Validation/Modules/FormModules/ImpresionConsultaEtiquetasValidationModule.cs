...
{
    public class ImpresionConsultaEtiquetasValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IIdentityService _identity;

        public ImpresionConsultaEtiquetasValidationModule(IUnitOfWork uow, IIdentityService identity)
        {
            this._uow = uow;
