...
{
    public class ImpresionTransferenciaValidationModule : FormValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IIdentityService _identity;

        public ImpresionTransferenciaValidationModule(IUnitOfWork uow, IIdentityService identity)
        {
            this._uow = uow;
        ...
        public virtual void ValidateImpresora_OnSucess(FormField field, Form form, List<ComponentParameter> parameters)
        {
            ...
            if (!parameters.Any(s => s.Id == "isSubmit"))
            {
                ...
                List<EtiquetaEstiloLenguaje> listaEstilos = _uow.ImpresionRepository.GetEstiloByLenguaje(lenguaje.Id, EstiloEtiquetaDb.Transferencia);
        ...
        {
            if (parameters.Count > 0 && parameters.Find(x => x.Id == "generarEtiquetas") != null)
                return null;
