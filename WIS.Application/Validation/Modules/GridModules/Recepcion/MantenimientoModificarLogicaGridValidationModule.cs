...
{
    public class MantenimientoModificarLogicaGridValidationModule : GridValidationModule
    {
        ...
        public MantenimientoModificarLogicaGridValidationModule(IUnitOfWork uow, IIdentityService securityService, List<ComponentParameter> parameters)
        {
            this._uow = uow;
            ...
            {
                ["VL_ALM_PARAMETRO"] = this.GridValidateParametro,
            };
        }
