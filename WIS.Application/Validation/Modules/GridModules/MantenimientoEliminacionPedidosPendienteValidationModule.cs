...
{
    public class MantenimientoEliminacionPedidosPendienteValidationModule : GridValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IFormatProvider _culture;

        public MantenimientoEliminacionPedidosPendienteValidationModule(IUnitOfWork uow, IFormatProvider culture)
        {
            this._uow = uow;
        ...
        public virtual GridValidationGroup ValidateCantAnular(GridCell cell, GridRow row, List<ComponentParameter> parameters)
        {
            ...
            var rules = new List<IValidationRule> {
                ...
                new CantidadAnularMayorQueAsociadoValidationRule(cell.Value, row.GetCell("QT_PENDIENTE_LPN").Value, row.GetCell("QT_PENDIENTE").Value, _culture)
            };
