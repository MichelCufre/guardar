...
{
    public class MantenimientoEliminacionPedidosPendienteLpnValidationModule : GridValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IFormatProvider _culture;

        public MantenimientoEliminacionPedidosPendienteLpnValidationModule(IUnitOfWork uow, IFormatProvider culture)
        {
            this._uow = uow;
        ...
        public virtual GridValidationGroup ValidateCantAnular(GridCell cell, GridRow row, List<ComponentParameter> parameters)
        {
            ...
            var rules = new List<IValidationRule> {
                ...
                new CantidadAnularMayorQueAsociadoValidationRule(cell.Value, row.GetCell("QT_PENDIENTE_ATRIB").Value,row.GetCell("QT_PENDIENTE").Value, _culture)
            };
