...
{
    public class EVT040CrearInstanciaGridValidationModule : GridValidationModule
    {
        ...
        public EVT040CrearInstanciaGridValidationModule(IUnitOfWork uow, string empresa, string tipoAgente, ISessionAccessor sessionAccessor)
        {
            this._uow = uow;
