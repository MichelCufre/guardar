...
{
    public class DefinicionFormulaLineaSalidaValidationModule : GridValidationModule
    {
        protected readonly IUnitOfWork _uow;
        protected readonly IFormatProvider _formatProvider;

        public DefinicionFormulaLineaSalidaValidationModule(IUnitOfWork uow, IFormatProvider formatProvider)
        {
            this._uow = uow;
        ...
        public virtual GridValidationGroup ValidateCodigoProducto(GridCell cell, GridRow row, List<ComponentParameter> parameters)
        {
            ...
            if (validarProductoRepetidos) //Control cruzado
                rules.Add(new FormulaInsumoExistenteValidationRule(_uow, codigoFormula, cell.Value));
