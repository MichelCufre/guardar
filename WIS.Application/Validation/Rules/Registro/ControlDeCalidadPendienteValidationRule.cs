...
{
    public class ControlDeCalidadPendienteValidationRule : IValidationRule
    {
        ...
        public ControlDeCalidadPendienteValidationRule(IUnitOfWork uow, string control, string empresa, string producto)
        {
        ...
        public virtual List<IValidationError> Validate()
        {
            ...
            if (_uow.ControlDeCalidadRepository.AnyControlDeCalidadPendienteSinAceptar(idControl, idEmpresa, _producto))
            {
                errors.Add(new ValidationError("REG602_Sec0_Error_ControlCalidadPendiente"));
            }
