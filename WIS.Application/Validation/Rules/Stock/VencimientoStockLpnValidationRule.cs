...
{
	public class VencimientoStockLpnValidationRule : IValidationRule
	{
		...
		protected readonly DateTime? _oldValue;
		...
		protected readonly bool _isExpirable;

		public VencimientoStockLpnValidationRule(IUnitOfWork uow, DateTime? value, DateTime? oldValue, long nuLpn, int idLpnDet, string ubicacion, int empresa, string producto, string identificador, decimal faixa, decimal qtStock, bool isExpirable)
		{
		...
		public virtual List<IValidationError> Validate()
		{
            ...
            if (_isExpirable && _value < DateTime.Now && _oldValue > DateTime.Now && _qtStock != cantidadDisponibleLpn)
