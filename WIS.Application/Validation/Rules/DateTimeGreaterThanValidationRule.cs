...
{
    public class DateTimeGreaterThanValidationRule : IValidationRule
    {
        protected readonly string _valueDateString;
        protected readonly string _valueDateReference;
        protected readonly string _message;

        public DateTimeGreaterThanValidationRule(string valueDateString, string valueDateReference, string message = null)
        {
