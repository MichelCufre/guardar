...
{
	public class PRD113RemanenteInsumos : AppController
	{
			...
			IGridValidationService gridValidationService)
		{
			...
			this.GridKeys = new List<string> { "CD_PRODUTO", "CD_EMPRESA", "NU_IDENTIFICADOR", "NU_PRDC_INGRESO", "NU_PRDC_INGRESO_REAL", "FL_CONSUMIBLE" };
		...
		public override Grid GridFetchRows(Grid grid, GridFetchContext context)
		{
			...
			var dbQuery = new RemanenteInsumosQuery(idIngreso, empresa);
