...
{
	public class PRD113RemanenteProducido : AppController
	{
		...
		public PRD113RemanenteProducido(
		...
		public override Grid GridFetchRows(Grid grid, GridFetchContext context)
		{
			...
			var ubicacionProduccion = context.GetParameter("ubicacionProduccion");
			...
			var dbQuery = new RemanenteProducidoQuery(ubicacionProduccion, empresa);
