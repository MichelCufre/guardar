...
{
    public class IMP050ImpresionHerramientasPosicion : AppController
    {
        ...
        public IMP050ImpresionHerramientasPosicion(IIdentityService identity,
        ...
        public override Form FormSubmit(Form form, FormSubmitContext context)
        {
            ...
            var cdEquipo = JsonConvert.DeserializeObject<string>(context.Parameters.FirstOrDefault(x => x.Id == "equipo")?.Value);
            ...
            var fin = int.Parse(form.GetField("maximo").Value);
            var inicio = int.Parse(form.GetField("minimo").Value);
            ...
            {
                var posicion = equipo.Copiar();
                posicion.PosicionEquipo = GeneralDb.SeparadorEquipoPosicion + i;
                equipos.Add(posicion);
            }
        ...
        public override Form FormValidateForm(Form form, FormValidationContext context)
        {
            ...
            return this._formValidationService.Validate(new ImpresionesEquipoPosicionValidationModule(uow, this._identity.UserId, this._identity.Predio), form, context);
        }
        ...
        public virtual void InicializarSelect(IUnitOfWork uow, Form form)
        {
            ...
            if (selectorImpresora.Value != "")
            {
                ...
                List<EtiquetaEstiloLenguaje> listaEstilos = uow.ImpresionRepository.GetEstiloByLenguaje(lenguaje, EstiloEtiquetaDb.EquipoPosicion);
            ...
            {
                List<EtiquetaEstiloLenguaje> listaEstilos = uow.ImpresionRepository.GetEstiloByTipo(EstiloEtiquetaDb.EquipoPosicion);
                foreach (var estilo in listaEstilos)
                {
                    selectorEstilo.Options.Add(new SelectOption(estilo.CodigoLabel, $"{estilo.CodigoLabel} - {estilo.Descripcion}"));
                }
