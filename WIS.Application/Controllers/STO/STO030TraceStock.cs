...
{
    public class STO030TraceStock : AppController
    {
        ...
        public STO030TraceStock(IGridExcelService excelService, IUnitOfWorkFactory uowFactory, IGridService gridService, IIdentityService identity, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            var dbQuery = new TraceStockQuery();
