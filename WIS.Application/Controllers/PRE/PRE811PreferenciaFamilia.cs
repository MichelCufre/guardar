...
{
    public class PRE811PreferenciaFamilia : AppController
    {
        ...
        public PRE811PreferenciaFamilia(
            ...
            IIdentityService identity)
        {
            ...
            {
                new SortCommand("CD_FAMILIA_PRODUTO",SortDirection.Descending)
            };
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            try
            {
                ...
                if (grid.Id == "AgregarFamilia_grid_1")
                {
                    var dbQuery = new AgregarFamiliaPreferenciaQuery(int.Parse(codigoPreferencia));
                ...
                else if (grid.Id == "QuitarFamilia_grid_2")
                {
                    if (!string.IsNullOrEmpty(codigoPreferencia))
                    {
                        ...
                        var dbQuery = new QuitarFamiliaPreferenciaQuery(preferencia.NU_PREFERENCIA);
        ...
        public override GridStats GridFetchStats(Grid grid, GridFetchStatsContext context)
        {
            ...
            if (!string.IsNullOrEmpty(codigoPreferencia))
            {
                ...
                {
                    var dbQuery = new QuitarFamiliaPreferenciaQuery(int.Parse(codigoPreferencia));
                    uow.HandleQuery(dbQuery);
                    dbQuery.ApplyFilter(this._filterInterpreter, context.Filters);
        ...
        public override byte[] GridExportExcel(Grid grid, GridExportExcelContext context)
        {
            ...
            if (grid.Id == "AgregarFamilia_grid_1")
            {
                var dbQuery = new AgregarFamiliaPreferenciaQuery(nuPreferencia);
                uow.HandleQuery(dbQuery);
            ...
            {
                var dbQuery = new QuitarFamiliaPreferenciaQuery(nuPreferencia);
                uow.HandleQuery(dbQuery);
        ...
        {
            if (context.GridId == "AgregarFamilia_grid_1" && context.ButtonId == "btnAgregar")
            {
                this.ProcesarAgregar(context);
            }
            else if (context.GridId == "QuitarFamilia_grid_2" && context.ButtonId == "btnQuitar")
            {
        ...
        public virtual void ProcesarAgregar(GridMenuItemActionContext context)
        {
            ...
            try
            {
                ...
                List<PreferenciaAsociarFamilia> clientes = new List<PreferenciaAsociarFamilia>();
                ...
                uow.PreferenciaRepository.AddFamiliasPreferencia(clientes);
                uow.SaveChanges();
                uow.Commit();
            }
            catch (ValidationFailedException ex)
        ...
        public virtual void ProcesarQuitar(GridMenuItemActionContext context)
        {
            ...
            try
            {
                ...
                uow.PreferenciaRepository.RemoveFamiliasPreferencia(clientes);
                uow.SaveChanges();
                uow.Commit();
            }
            catch (ValidationFailedException ex)
