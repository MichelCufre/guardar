...
namespace WIS.Application.Controllers.PRE
{
    ...
    public class PRE110DetPedidoAtr : AppController
    {
        ...
        protected readonly ILogger<PRE110DetPedidoAtr> _logger;
        ...
        public PRE110DetPedidoAtr(
            IIdentityService identity,
            ILogger<PRE110DetPedidoAtr> logger,
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            PedidosAtributosPendientesQuery dbQuery;
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                dbQuery = new PedidosAtributosPendientesQuery(pedido, empresa, cliente, idEspecificaIdentificador, producto, identificador, faixa, nuDetPedSaiAtrib);
        ...
        public override byte[] GridExportExcel(Grid grid, GridExportExcelContext context)
        {
            ...
            var dbQuery = new PedidosAtributosPendientesQuery(pedido, empresa, cliente, idEspecificaIdentificador, producto, identificador, faixa, nuDetPedSaiAtrib);
