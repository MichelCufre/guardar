...
{
    public class PRE810PonderadorFechaEntrega : AppController
    {
        ...
        public PRE810PonderadorFechaEntrega(
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            try
            {
                ...
                ColaDeTrabajoPonderadorQuery query = new ColaDeTrabajoPonderadorQuery(nuColaDeTrabajo, ColasTrabajoDb.CondicionFechaEntrega);
        ...
        public override GridStats GridFetchStats(Grid grid, GridFetchStatsContext context)
        {
            ...
            if (int.TryParse(strColaDeTrabajo, out int nuColaDeTrabajo))
            {
                query = new ColaDeTrabajoPonderadorQuery(nuColaDeTrabajo, ColasTrabajoDb.CondicionFechaEntrega);
        ...
        public override Grid GridCommit(Grid grid, GridFetchContext context)
        {
            ...
            try
            {
                if (grid.Rows.Any())
                {
                    ...
                    {
                        if (row.IsDeleted)
                            logicCola.DeletePonderadorDetalle(uow, nuColaDeTrabajo, row.GetCell("CD_INST_PONDERADOR").Value, ColasTrabajoDb.CondicionFechaEntrega);
                    }
                }
        ...
        public override Form FormInitialize(Form form, FormInitializeContext context)
        {
            ...
            if (int.TryParse(context.Parameters.FirstOrDefault(s => s.Id == "NU_COLA_TRABAJO")?.Value, out int nuColaTrabajo))
            {
                ...
                var detallePonderador = uow.ColaDeTrabajoRepository.GetPonderadorDetalle(nuColaTrabajo, ColasTrabajoDb.CondicionFechaEntrega, instPonderador);
        ...
        public override Form FormSubmit(Form form, FormSubmitContext context)
        {
            ...
            try
            {
                ...
                LColasDeTrabajo logicCola = new LColasDeTrabajo(uow, _identity, _logger);
                logicCola.EditarPonderadorDetalle(nuColaDeTrabajo, int.Parse(form.GetField("ponderacion").Value), ColasTrabajoDb.CondicionFechaEntrega, srtOperador, totalHoras);
