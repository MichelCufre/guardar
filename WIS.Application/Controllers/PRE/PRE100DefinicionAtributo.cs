...
{
    public class PRE100DefinicionAtributo : AppController
    {
        protected readonly IUnitOfWorkFactory _uowFactory;
        protected readonly IIdentityService _identity;
        protected readonly IFormValidationService _formValidationService;

        public PRE100DefinicionAtributo(IUnitOfWorkFactory uowFactory, IIdentityService identity, IFormValidationService formValidationService)
        {
        ...
        public override Form FormSubmit(Form form, FormSubmitContext context)
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    uow.ManejoLpnRepository.AddAtributoTemporal(newAtributoTemporal);
        ...
        public virtual DetallePedidoAtributoTemporal CrearDefinicionAtributo(IUnitOfWork uow, Form form, DetallePedidoLpnEspecifico datos, KeyAtributoTipo atributoDefinicion)
        {
            var newAtributoTemporal = new DetallePedidoAtributoTemporal()
            {
                Pedido = datos.Pedido,
        ...
        public virtual DetallePedidoLpnEspecifico GetDatos(List<ComponentParameter> parametros, bool gridDetalle = false)
        {
            ...
            if (dto.Update)
            {
                ...
                dto.Cantidad = decimal.Parse(parametros.FirstOrDefault(p => p.Id == "cantidad").Value, _identity.GetFormatProvider());
            }
            else
            {
                dto.Faixa = 1;
