...
{
    public class EXP090ConsultaDeCargasAsignadas : AppController
    {
        ...
        public EXP090ConsultaDeCargasAsignadas(IGridExcelService excelService, IUnitOfWorkFactory uowFactory, IGridService gridService, IIdentityService identity, IFilterInterpreter filterInterpreter)
        {
            this.GridKeys = new List<string>
            {
                "NU_PEDIDO", "CD_CLIENTE", "CD_EMPRESA", "NU_PREPARACION", "NU_CARGA", "CD_CAMION"
            };
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            var dbQuery = new ConsultaDeCargasAsignadasQuery();
