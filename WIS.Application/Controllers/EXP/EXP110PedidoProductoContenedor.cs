...
{
    public class EXP110PedidoProductoContenedor : AppController
    {
        ...
        public EXP110PedidoProductoContenedor(IIdentityService identity,
            ...
            IFilterInterpreter filterInterpreter)
        {
            ...
            {
                "CD_PRODUTO", "CD_EMPRESA", "NU_PREPARACION", "NU_PEDIDO", "CD_CLIENTE"
            };
        ...
        {
            var queryData = GetPedidoProductoContenedorQueryData(context);
            ...
            var dbQuery = new PedidoProductoContenedorQuery(queryData);
            ...
            if (grid.Rows.Count == 1)
            {
                ...
                context.AddOrUpdateParameter("AUX_ROW_SELECTED_PEDPRODCONT", grid.Rows.FirstOrDefault().Id);
                return grid;
            }

            string rowSelected = context.GetParameter("AUX_ROW_SELECTED_PEDPRODCONT");
            ...
            if (grid.Rows.Count > 1 && !string.IsNullOrEmpty(rowSelected))
            {
                ...
                grid.Rows.FirstOrDefault(x => x.GetCell("CD_PRODUTO").Value == keys[0] &&
                                              ...
                                              x.GetCell("NU_PREPARACION").Value == keys[2] &&
                                              x.GetCell("NU_PEDIDO").Value == keys[3] &&
                                              x.GetCell("CD_CLIENTE").Value == keys[4]).CssClass = "blue";
            }
        ...
        public override GridButtonActionContext GridButtonAction(GridButtonActionContext context)
        {
            ...
            {
                context.AddOrUpdateParameter("AUX_ROW_SELECTED_PEDPRODCONT", context.Row.Id);
            }

            return context;
        }

        protected virtual PedidoProductoContenedorQueryData GetPedidoProductoContenedorQueryData(ComponentContext context)
        {
            ...
            return new PedidoProductoContenedorQueryData
            {
