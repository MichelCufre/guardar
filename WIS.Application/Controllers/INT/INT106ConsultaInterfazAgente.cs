...
{
    public class INT106ConsultaInterfazAgente : AppController
    {
        ...
        public INT106ConsultaInterfazAgente(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanAgenteQuery dbQuery = new EstanAgenteQuery(nuInterfaz);
