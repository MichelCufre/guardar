...
{
    public class INT107ConsultaInterfazPedidosConferidos : AppController
    {
        ...
        public INT107ConsultaInterfazPedidosConferidos(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanConfPedidoQuery dbQuery = new EstanConfPedidoQuery(nuInterfaz);
