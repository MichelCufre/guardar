...
{
    public class INT108ConsultaInterfazConversor : AppController
    {
        ...
        public INT108ConsultaInterfazConversor(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanConvertedorQuery dbQuery = new EstanConvertedorQuery(nuInterfaz);
