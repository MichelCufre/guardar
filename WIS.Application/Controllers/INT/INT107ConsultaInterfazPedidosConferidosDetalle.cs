...
{
    public class INT107ConsultaInterfazPedidosConferidosDetalle : AppController
    {
        ...
        public INT107ConsultaInterfazPedidosConferidosDetalle(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanConfPedidoDetQuery dbQuery = new EstanConfPedidoDetQuery(nuInterfaz);
