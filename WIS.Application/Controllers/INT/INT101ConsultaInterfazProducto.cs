...
{
    public class INT101ConsultaInterfazProducto : AppController
    {
        ...
        public INT101ConsultaInterfazProducto(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanProductoQuery dbQuery = new EstanProductoQuery(nuInterfaz);
