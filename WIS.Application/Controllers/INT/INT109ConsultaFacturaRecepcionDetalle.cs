...
{
    public class INT109ConsultaFacturaRecepcionDetalle : AppController
    {
        ...
        public INT109ConsultaFacturaRecepcionDetalle(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanFacturaRecDetQuery dbQuery = new EstanFacturaRecDetQuery(nuInterfaz);
