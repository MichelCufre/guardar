...
{
    public class INT104ConsultaInterfazPedidosAnulados : AppController
    {
        ...
        public INT104ConsultaInterfazPedidosAnulados(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanPedidoAnuladoQuery dbQuery = new EstanPedidoAnuladoQuery(nuInterfaz);
