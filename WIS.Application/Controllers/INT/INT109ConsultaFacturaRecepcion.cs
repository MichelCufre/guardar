...
{
    public class INT109ConsultaFacturaRecepcion : AppController
    {
        ...
        public INT109ConsultaFacturaRecepcion(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanFacturaRecQuery dbQuery = new EstanFacturaRecQuery(nuInterfaz);
