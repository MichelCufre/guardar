...
{
    public class INT100ConsultaInterfazPedidosSalidaDetalle : AppController
    {
        ...
        public INT100ConsultaInterfazPedidosSalidaDetalle(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanPedidoSalidaDetQuery dbQuery = new EstanPedidoSalidaDetQuery(nuInterfaz);
