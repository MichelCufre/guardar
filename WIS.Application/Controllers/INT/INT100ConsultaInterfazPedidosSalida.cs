...
{
    public class INT100ConsultaInterfazPedidosSalida : AppController
    {
        ...
        public INT100ConsultaInterfazPedidosSalida(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanPedidoSalidaQuery dbQuery = new EstanPedidoSalidaQuery(nuInterfaz);
