...
{
    public class INT102ConsultaInterfazCodigoBarra : AppController
    {
        ...
        public INT102ConsultaInterfazCodigoBarra(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanCodigoBarrasQuery dbQuery = new EstanCodigoBarrasQuery(nuInterfaz);
