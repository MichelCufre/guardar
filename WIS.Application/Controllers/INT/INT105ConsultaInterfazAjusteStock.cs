...
{
    public class INT105ConsultaInterfazAjusteStock : AppController
    {
        ...
        public INT105ConsultaInterfazAjusteStock(IIdentityService identity, IUnitOfWorkFactory uowFactory, IGridService gridService, IGridExcelService excelService, IFilterInterpreter filterInterpreter)
        {
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext context)
        {
            ...
            if (context.Parameters.Count > 0)
            {
                ...
                EstanAjusteStockQuery dbQuery = new EstanAjusteStockQuery(nuInterfaz);
