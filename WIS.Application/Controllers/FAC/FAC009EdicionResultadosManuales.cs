...
{
    public class FAC009EdicionResultadosManuales : AppController
    {
        ...
        protected readonly ILogger<FAC009EdicionResultadosManuales> _logger;
        protected readonly IGridValidationService _gridValidationService;

        protected List<string> GridKeys { get; }
        protected List<SortCommand> DefaultSort { get; }

        public FAC009EdicionResultadosManuales(
            ...
            ILogger<FAC009EdicionResultadosManuales> logger,
        ...
        public override Grid GridFetchRows(Grid grid, GridFetchContext query)
        {
            ...
            IngresoResultadosManualesQuery dbQuery = new IngresoResultadosManualesQuery(int.Parse(nuEjecucion), "FAC009");
        ...
        {
            return this._gridValidationService.Validate(new MantenimientoIngresoResultadosManualesGridValidationModule(this._identity.GetFormatProvider()), grid, row, context);
        }
        ...
        public virtual FacturacionResultado UpdateFacturacionResultado(IUnitOfWork uow, GridRow row, GridFetchContext query)
        {
            ...
            var facturacionResultado = uow.FacturacionRepository.GetFacturacionResultado(int.Parse(cdEmpresa), cdFacturacion, int.Parse(nuEjecucion), componente);
