...
{
    public class DOC400 : AppController
    {
        ...
        public DOC400(ISessionAccessor session,
        ...
        public override Grid GridValidateRow(GridRow row, Grid grid, GridValidationContext context)
        {
            ...
            return this._gridValidationService.Validate(new DOC400GridValidationModule(uow, this._identity.GetFormatProvider()), grid, row, context);
        }
            ...
            using (var uow = this._uowFactory.GetUnitOfWork())
            {
                try
                {
                    ...
                    foreach (var row in grid.Rows)
                    {
                        ...
                        var existeDoc = egreso.ValidarCambioIngr(uow, fecha, docNuevo, "DI", this._identity.Application, this._identity.UserId, false);
                        var doc = new CambioDocumentoDetIngreso();

                        doc.NU_DOCUMENTO_NUEVO = docNuevo;
                        doc.TP_DOCUMENTO_NUEVO = "DI";
