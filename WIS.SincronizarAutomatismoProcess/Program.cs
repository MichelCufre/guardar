...
namespace WIS.SincronizarAutomatismoProcess
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    var app = serviceProvider.GetService<ILiberacionOndaSyncBackgroundProcess>();
        ...
        public static void SetIdentity(ServiceProvider serviceProvider)
        {
            ...
            manager.SetUser(new BasicUserData
            {
                Language = "es",
                UserId = -1
            }, "JobSincroAuto", GeneralDb.PredioSinDefinir);
        }
        ...
        public static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.AddScoped<ILiberacionOndaSyncBackgroundProcess, LiberacionOndaSyncBackgroundProcess>();
