...
namespace WIS.Filtering.FilterExpressions
{
    public class FilterExpressionLessThanOrEqual : IFilterExpression
    {
        ...
        public FilterExpressionLessThanOrEqual(IExpressionService expressionService, IFilterExpression expressionLeft, IFilterExpression expressionRight)
        {
        ...
        {
            return this._expressionService.LessThanOrEqual(this.ExpressionLeft.Evaluate(context), this.ExpressionRight.Evaluate(context));
        }
    }
}
