...
{
    public class FilterExpressionAdd : IFilterExpression
    {
        private readonly IExpressionService _expressionService;
        private IFilterExpression ExpressionLeft { get; set; }
        private IFilterExpression ExpressionRight { get; set; }

        public FilterExpressionAdd(IExpressionService expressionService, IFilterExpression expressionLeft, IFilterExpression expressionRight)
        {
        ...
        public Expression Evaluate(FilterExpressionContext context)
        {
            ...
            return Expression.MakeBinary(ExpressionType.Add, expLeft, expRight);
        }
    }
}
