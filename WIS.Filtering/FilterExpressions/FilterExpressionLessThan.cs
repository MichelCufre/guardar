...
namespace WIS.Filtering.FilterExpressions
{
    public class FilterExpressionLessThan : IFilterExpression
    {
        ...
        public FilterExpressionLessThan(IExpressionService expressionService, IFilterExpression expressionLeft, IFilterExpression expressionRight)
        {
        ...
        {
            return this._expressionService.LessThan(this.ExpressionLeft.Evaluate(context), this.ExpressionRight.Evaluate(context));
        }
    }
}
