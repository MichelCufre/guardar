...
namespace WIS.Filtering.FilterExpressions
{
    public class FilterExpressionGreaterThanOrEqual : IFilterExpression
    {
        ...
        public FilterExpressionGreaterThanOrEqual(IExpressionService expressionService, IFilterExpression expressionLeft, IFilterExpression expressionRight)
        {
        ...
        {
            return this._expressionService.GreaterThanOrEqual(this.ExpressionLeft.Evaluate(context), this.ExpressionRight.Evaluate(context));
        }
    }
}
